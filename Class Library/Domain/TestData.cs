namespace Class_Library.Domain
{
    ...
    {
        public static Plane BoingPlane = new Plane { PlaneType = PlaneType.Boeing, Capacity = 150, ManufactureDate = new DateTime(215, 02, 03) };
       ...
       ,
        ...
        public static Flight flight3 = new Flight { FlightDate = new DateTime(2022, 01, 01, 5, 10, 10), Destination = "Paris", EffectiveArrival = new DateTime(2022, 03, 01, 6, 40, 10), EstimatedDuration = 100, Plane = BoingPlane };
